...
module.exports = class ActionEightButtonDriver extends Homey.Driver {
  ...
  async onInit() {
    ...
    this.homey.flow.getActionCard('action-8-button_on')
    ...
    this.homey.flow.getActionCard('action-8-button_off')
      .registerRunListener(async (args) => {
        const { device } = args;
