...
module.exports = class ActionThreeButtonDriver extends Homey.Driver {
  ...
  async onInit() {
    ...
    this.homey.flow.getActionCard('action-3-button_on')
    ...
    this.homey.flow.getActionCard('action-3-button_off')
      .registerRunListener(async (args) => {
        const { device } = args;
    ...
    this.homey.flow.getActionCard('action-3-button_timer')
      .registerRunListener(async (args) => {
